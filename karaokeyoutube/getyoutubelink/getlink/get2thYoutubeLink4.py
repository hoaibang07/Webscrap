...
if __name__ == '__main__':
    if os.path.isfile('out/youtubelist00004.txt'):
        f = io.open('out/youtubelist00004.txt', 'a', encoding = 'utf-8')
    else:
        f = io.open('out/youtubelist00004.txt', 'w', encoding = 'utf-8')
