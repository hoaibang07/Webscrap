...
def main():
    ...
    try:
        ...
        for i in xrange(0,24):
            ...
            #thay the dau cham phay bang dau cac de sau nay dung dau cham phay lam ki hieu ngan cach
            #yeu cau dinh dang file text youtube de hat
...
if __name__ == '__main__':
    if os.path.isfile('out/youtubelist00001_bs.txt'):
        f = io.open('out/youtubelist00001_bs.txt', 'a', encoding = 'utf-8')
    else:
        f = io.open('out/youtubelist00001_bs.txt', 'w', encoding = 'utf-8')
    f2 = open('danhsachmoithemvao.txt', 'r')
    main()
    f.close()
